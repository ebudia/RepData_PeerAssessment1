...
+ The mean is `r paste(mean.activity)` steps. Is the same as the previous because i use the mean to fill 
+ The median is `r paste(median.activity)` steps. Is diferent because i have new values
